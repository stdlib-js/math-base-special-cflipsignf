...
```javascript
import cflipsignf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cflipsignf@v0.3.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-cflipsignf/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/math-base-special-cflipsignf/actions/workflows/test.yml?query=branch:v0.3.0
